            ...
            return (
                <div className="container-fluid row">
                    <ol className="breadcrumb">
                        <li>服务器管理</li>
                        <li className="active">服务器开启关闭</li>
                    </ol>
                    ...
                    <div className={'btn-group col-md-4 col-sm-6 col-xs-10 ' + this.state.entrancebtn}>
                        ...
                        <button className="btn btn-success" onClick={this.start}>开启</button>
                        <button className="btn btn-danger" onClick={this.stop}>关闭</button>
                    </div>
                    {/* 成功OR失败 */}
